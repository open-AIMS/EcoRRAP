...
Script for network processing. Given a set of high quality aligned photos,
it resizes the bounding box then duplicates the chunk, with the goal
of preserving all the points in case something in the next step
